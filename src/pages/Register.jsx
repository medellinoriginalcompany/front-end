  ...
  return (
    <div className="h-screen md:flex">
      <div
        ...
        <div>
          <h1 className="text-white font-bold text-4xl font-sans">Medellin</h1>
        </div>
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        ...
        <h1 className="text-gray-800 font-bold text-2xl mb-1">Welcome to Medellin! Please register</h1>
          <p className="text-sm font-semibold text-red-600 mb-7">Blablablablabla</p>
          ...
          <button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Registro</button>
